  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-bold text-white">Utilisasi Kantor Cabang</h2>
          <p className="text-xs text-slate-400 mt-0.5">Statistik penggunaan vault per cabang</p>
        </div>
        <Select value={period} onValueChange={(v) => setPeriod(v ?? 'Minggu Ini')}>
          <SelectTrigger className="w-[150px] bg-white/5 border-white/10 text-white text-xs">
      ...
      <div className="grid gap-3 grid-cols-2 sm:grid-cols-4">
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
          <p className="text-[10px] text-slate-500 uppercase tracking-wider">Total Akses</p>
          <p className="text-2xl font-bold text-white mt-1">406</p>
          <p className="text-[10px] text-emerald-400 mt-0.5 flex items-center gap-1">
            <TrendingUp className="h-3 w-3" /> +12% dari minggu lalu
          </p>
        </div>
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
          <p className="text-[10px] text-slate-500 uppercase tracking-wider">Rata-rata Durasi</p>
          <p className="text-2xl font-bold text-white mt-1">8.5<span className="text-sm text-slate-400">min</span></p>
          <p className="text-[10px] text-slate-400 mt-0.5">Per sesi akses</p>
        </div>
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
          <p className="text-[10px] text-slate-500 uppercase tracking-wider">Total Alarm</p>
          <p className="text-2xl font-bold text-red-400 mt-1">15</p>
          <p className="text-[10px] text-red-400/70 mt-0.5">3 belum ditangani</p>
        </div>
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
          <p className="text-[10px] text-slate-500 uppercase tracking-wider">Cabang Aktif</p>
          <p className="text-2xl font-bold text-white mt-1">11<span className="text-sm text-slate-400">/12</span></p>
          <p className="text-[10px] text-emerald-400 mt-0.5">91.7% online</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-xl border border-white/10 bg-white/[0.02] p-4">
          <h3 className="text-sm font-medium text-white mb-4">Frekuensi Akses per Cabang</h3>
        ...
        <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
          <h3 className="text-sm font-medium text-white mb-4">Distribusi Status Vault</h3>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
      ...
      {/* Weekly Trend */}
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
        <h3 className="text-sm font-medium text-white mb-4">Tren Akses Mingguan</h3>
